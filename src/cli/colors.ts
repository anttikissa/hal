...
const thinkingMd = {
	bold: [fg(oklch(0.93, 0.01, 250)), thinking.fg] as [string, string],
	italic: ['\x1b[3m', '\x1b[23m'] as [string, string],
	code: [fg(oklch(0.83, 0.03, 250)), thinking.fg] as [string, string],
}
...
export { RESET, DIM, SEL_ON, SEL_OFF, assistant, assistantMd, input, system, thinking, thinkingMd, info, error, cursor, tool }
