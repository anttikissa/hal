...
async function prepareAnswer(question: ProjectedQuestion, sessionId: string, value: string): Promise<AnswerValue> {
	...
	const ciphertext = await questionCrypto.encryptSecret(question.input.publicKey, sessionId, question.id, value)
