...
function systemPrompt(): string {
	return [
		...
		'Use simple sentences and common words, like the ASD-STE100 standard.',
		'Use concrete examples of what happened. Add an occasional colorful remark only when it helps understanding.',
